	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="监管者账号" prop="jianguanzhezhanghao" >
					<el-input v-model="ruleForm.jianguanzhezhanghao" placeholder="监管者账号" clearable  :readonly="ro.jianguanzhezhanghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="监管者账号" prop="jianguanzhezhanghao" >
					<el-input v-model="ruleForm.jianguanzhezhanghao" placeholder="监管者账号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="监管者姓名" prop="jianguanzhexingming" >
					<el-input v-model="ruleForm.jianguanzhexingming" placeholder="监管者姓名" clearable  :readonly="ro.jianguanzhexingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="监管者姓名" prop="jianguanzhexingming" >
					<el-input v-model="ruleForm.jianguanzhexingming" placeholder="监管者姓名" readonly></el-input>
				</el-form-item>
			</template>
		...
		data() {
			...
			return {
				...
				ro:{
					...
					jianguanzhezhanghao : false,
					jianguanzhexingming : false,
				},
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='jianguanzhezhanghao'){
							this.ruleForm.jianguanzhezhanghao = obj[o];
							this.ro.jianguanzhezhanghao = true;
							continue;
						}
						if(o=='jianguanzhexingming'){
							this.ruleForm.jianguanzhexingming = obj[o];
							this.ro.jianguanzhexingming = true;
							continue;
						}
					}
				}
				...
				this.$http({
					...
					if (data && data.code === 0) {
						var json = data.data;
						if(((json.jianguanzhezhanghao!=''&&json.jianguanzhezhanghao) || json.jianguanzhezhanghao==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.jianguanzhezhanghao = json.jianguanzhezhanghao
							this.ro.jianguanzhezhanghao = true;
						}
						if(((json.jianguanzhexingming!=''&&json.jianguanzhexingming) || json.jianguanzhexingming==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.jianguanzhexingming = json.jianguanzhexingming
							this.ro.jianguanzhexingming = true;
						}
					} else {
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `zhiliangjiance/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zhiliangjianceCrossAddOrUpdateFlag = false;
											this.parent.search();
