				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('dingdanxinxi','物流运输')" @click="wuliuyunshuCrossAddOrUpdateHandler(scope.row,'cross','否','是','zhuangtai','已发货','已发货,待发货'.split(',')[0])" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								物流运输
							</el-button>
...
<script>
	...
	export default {
		...
		methods: {
			...
			wuliuyunshuCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
